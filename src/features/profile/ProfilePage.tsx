...
import { SERVICE_COMPANY_LABEL, type ServiceCompany } from "../../api/users";
    ...
    <div className="rounded-card border border-border bg-white p-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <div className={READONLY_CLASS}>{staff.serviceCompany ? (SERVICE_COMPANY_LABEL[staff.serviceCompany as ServiceCompany] ?? staff.serviceCompany) : "—"}</div>
        </div>
        <div>
